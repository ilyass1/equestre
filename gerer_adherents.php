...
<body>
         ...
         <div class="row">
             <div class="col-sm-6 col-md-6" >
                    ...
                    <a href="ajout_adherent.php" target="_self">  <p> <b> AJOUTER <br> UN ADHÉRENT </b></p> </a>
            ...
            <a href="ajout_proprietaire.php" > <p> <b> AJOUTER <br> UN PROPRIÉTAIRE </b></p></a>
                </div>
           </div>
        </div>
        <div class="row">
            <div class="col-sm-12 col-md-12" style="margin-left: 3%">
               <div class="container modal-content text-center">
                
               <a href="modifier_adherent.php"> <p> <b> MODIFIER <br> ADHÉRENT / PROPRIÉTAIRE</b></p></a>
